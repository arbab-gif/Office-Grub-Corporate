...
(function () {
  ...
  var GROUPS = [
    ...
    { label:'People',   items:[ {k:'employees', label:'Employees', href:'employees.html'},
                                {k:'guests',    label:'Guests',    href:'#'} ] },
    { label:'Program',  items:[ {k:'benefit',      label:'Meal benefit',  href:'#', lock:true},
                                {k:'drops',        label:'Drop points',   href:'#'},
                                {k:'live',         label:'Live Kitchen',  href:'#'},
                                {k:'integrations', label:'Integrations',  href:'#'} ] },
    { label:'Service',  items:[ {k:'schedule',  label:'Schedule',       href:'#'},
                                {k:'manifests', label:'Manifests',      href:'manifests.html'},
                                {k:'issues',    label:'Service issues', href:'#'},
  ...
  var MAP = { 'index.html':'dashboard', 'employees.html':'employees',
              ...
              'invoices.html':'invoices', 'plans.html':'invoices' };
  ...
  var html = '<div class="fside-inner">'
    ...
    + '<a class="fnav-item" href="#">'+icon(ICONS.settings)+'<span>Settings</span></a></div>'
    + '</div>';
